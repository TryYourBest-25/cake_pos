...
export class ProductSizeController {
  ...
  @ApiResponse({ status: 201, description: 'Kích thước sản phẩm được tạo thành công' })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 409, description: 'Conflict - Kích thước đã tồn tại' })
  async create(@Body() createProductSizeDto: CreateProductSizeDto): Promise<product_size> {
  ...
  @ApiOperation({ summary: 'Lấy danh sách kích thước sản phẩm với pagination - TẤT CẢ ROLES' })
  @ApiResponse({ status: 200, description: 'Danh sách kích thước sản phẩm' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  async findAll(@Query() paginationDto: PaginationDto): Promise<PaginatedResult<product_size>> {
  ...
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Kích thước sản phẩm không tồn tại' })
  async findOne(@Param('id', ParseIntPipe) id: number): Promise<product_size | null> {
  ...
  @ApiResponse({ status: 200, description: 'Kích thước sản phẩm được cập nhật thành công' })
  @ApiResponse({ status: 400, description: 'Bad Request' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Kích thước sản phẩm không tồn tại' })
  ...
  @ApiParam({ name: 'id', description: 'Product Size ID', type: Number })
  @ApiResponse({ status: 204, description: 'Kích thước sản phẩm được xóa thành công' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Kích thước sản phẩm không tồn tại' })
  @ApiResponse({ status: 409, description: 'Conflict - Kích thước đang được sử dụng' })
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles(ROLES.STAFF, ROLES.MANAGER, ROLES.CUSTOMER)
  @ApiOperation({ summary: 'Lấy giá sản phẩm theo kích thước với pagination - TẤT CẢ ROLES' })
  @ApiParam({ name: 'id', description: 'Product Size ID', type: Number })
  @ApiResponse({ status: 200, description: 'Danh sách giá sản phẩm theo kích thước' })
  @ApiResponse({ status: 401, description: 'Unauthorized' })
  @ApiResponse({ status: 403, description: 'Forbidden - Insufficient permissions' })
  @ApiResponse({ status: 404, description: 'Kích thước sản phẩm không tồn tại' })
