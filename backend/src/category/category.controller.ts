...
export class CategoryController {
  ...
  @ApiOperation({
    summary: 'Xóa nhiều danh mục - Chỉ MANAGER',
    description:
      'Xóa nhiều danh mục cùng lúc. Các danh mục có sản phẩm sẽ không thể xóa.',
  })
  ...
  @Roles(ROLES.MANAGER)
  @ApiOperation({
    summary: 'Test endpoint for category controller - Chỉ MANAGER',
  })
