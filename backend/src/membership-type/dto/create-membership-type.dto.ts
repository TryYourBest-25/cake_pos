...
export class CreateMembershipTypeDto {
  @ApiProperty({ description: 'Tên loại thành viên (unique)', example: 'Vàng', maxLength: 50 })
  @IsString()
  @IsNotEmpty()
  @MaxLength(50)
  type: string;
  ...
  @ApiProperty({ description: 'Mô tả chi tiết về loại thành viên', example: 'Giảm giá 10% cho tất cả đơn hàng.', maxLength: 255, required: false })
  @IsOptional()
  @IsString()
  @MaxLength(255)
  description?: string;

  @ApiProperty({ description: 'Ngày hết hạn của loại thành viên (YYYY-MM-DD)', example: '2025-12-31', required: false })
  @IsOptional()
  @IsDateString()
  valid_until?: string; // Sẽ được chuyển thành Date object

  @ApiProperty({ description: 'Trạng thái kích hoạt của loại thành viên', example: true, default: true, required: false })
  @IsOptional()
  @IsBoolean()
